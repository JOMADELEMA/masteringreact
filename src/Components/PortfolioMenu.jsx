  ...
  return (
    <>
      ...
      <div className="contenedorGrid">
        ...
        <div className="contenedorHijoGrid text-5xl bg-fondo-volcan bg-cover">Photography 2</div>
        
        </Link>
        <Link to="/photography3" className="cardLink photos">
        <div className="contenedorHijoGrid text-5xl bg-fondo-antigua bg-cover">Photography 3</div>
