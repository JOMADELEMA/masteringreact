        ...
        <div className="dexRecomendations">
          ...
          <div className="dexRecomendationBody">
            ...
            <div className="pkmnDexStatus">
              {pkmn1.dexStatus ? <Pokeball color="black"/> : <Pokeball strokeWidth={0.5} color="gray"/>}
            </div>
          </div>
          ...
          <div className="dexRecomendationBody">
            ...
            <div className="pkmnDexStatus">
              {pkmn2.dexStatus ? <Pokeball color="black"/> : <Pokeball strokeWidth={0.5} color="gray"/>}
            </div>
          </div>
          ...
          <div className="dexRecomendationBody">
            ...
            <div className="pkmnDexStatus">
              {pkmn3.dexStatus ? <Pokeball color="black"/> : <Pokeball strokeWidth={0.5} color="gray"/>}
            </div>
          </div>
          ...
          <div className="dexRecomendationBody">
            ...
            <div className="pkmnDexStatus">
              {pkmn4.dexStatus ? <Pokeball color="black"/> : <Pokeball strokeWidth={0.5} color="gray"/>}
            </div>
          </div>
        </div>
      </div>
